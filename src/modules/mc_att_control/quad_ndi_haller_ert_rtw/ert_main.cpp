...
#include "quad_ndi_haller.h"           // Model's header file
#include "rtwtypes.h"

static quad_ndi_class rtObj;           // Instance of model class

// '<Root>/vehicle_attitude'
static real32_T arg_vehicle_attitude[6] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F };

// '<Root>/vehicle_attitude_setpoint'
static real32_T arg_vehicle_attitude_setpoint[4] = { 0.0F, 0.0F, 0.0F, 0.0F };

// '<Root>/param'
static real32_T arg_param[18] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,

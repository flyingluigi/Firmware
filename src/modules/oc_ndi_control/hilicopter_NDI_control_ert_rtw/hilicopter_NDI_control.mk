...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/hilicopter_NDI_control
...
PRODUCT_NAME              = hilicopter_NDI_control
MAKEFILE                  = hilicopter_NDI_control.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = hilicopter_NDI_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/hilicopter_NDI_control
...
INCLUDES_BUILDINFO = -I$(START_DIR)/hilicopter_NDI_control_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=hilicopter_NDI_control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/hilicopter_NDI_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"

...
## Generated on : Thu Sep 01 16:38:23 2016
...
MAKEFILE                  = quad_ndi.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = C:\PROGRA~1\MATLAB~2
MATLAB_BIN                = C:\PROGRA~1\MATLAB~2\bin
MATLAB_ARCH_BIN           = C:\PROGRA~1\MATLAB~2\bin\win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\mocherma\Dropbox\Matlab\miniquad_control
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = $(START_DIR)\quad_ndi_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\quad_ndi_ert_rtw\quad_ndi.c $(START_DIR)\quad_ndi_ert_rtw\quad_ndi_data.c $(START_DIR)\quad_ndi_ert_rtw\rtGetInf.c $(START_DIR)\quad_ndi_ert_rtw\rtGetNaN.c $(START_DIR)\quad_ndi_ert_rtw\rt_nonfinite.c

MAIN_SRC = $(START_DIR)\quad_ndi_ert_rtw\ert_main.c
...
OBJS = quad_ndi.obj quad_ndi_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\quad_ndi_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\quad_ndi_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
